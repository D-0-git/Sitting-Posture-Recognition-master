...
def process(input_image, params, model_params):
    ...
    print()
    position1 = checkPosition(all_peaks)  # check position of spine.
...
if __name__ == '__main__':  # main function of the program
    ...
    if not vi:
        ...
        canvas, position = process('./sample_images/hunchback.jpg', params, model_params)
        if position == 1:
            print("Hunchback")
        elif position == -1:
            print("Reclined")
